...
const testimonials = [
  {
    quote:
      '"Our 8 days in Dubai were unforgettable — the malls, the Magic Garden, the Futuristic Museum, the Aquarium, all of it. Adventure Journeys planned every detail beautifully. We\'d recommend them without hesitation."',
    name: 'Joslynne Klein',
  ...
  {
    quote:
      '"Lindsay Van der Merwe made every moment so special — honestly the best holiday ever! Everything was handled so professionally and seamlessly, there\'s nothing I\'d change."',
    name: 'Stephanie Andrew',
    location: 'Namibia',
  ...
  {
    quote:
      '"Dubai was everything — the Dubai Garden, Burj Khalifa, every outing was amazing! Nothing to improve, we\'d go again in a heartbeat."',
    name: 'Elizabeth May & Mildred Bezuidenhoudt',
      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.1 }}
          >
            {testimonials.map(({ quote, name, location, image, rating = 5 }) => (
              <motion.div
                key={name}
                variants={revealUp}
